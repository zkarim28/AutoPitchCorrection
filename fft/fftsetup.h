...
inline fft_vars* fft_con(int nfft)
{
...
inline void fft_des(fft_vars* membvars)
{
...
//     size nfft/2 + 1
inline void fft_forward(fft_vars* membvars, float* input, float* output_re, float* output_im)
{
    int ti;
    int nfft;
    int hnfft;
...
inline void fft_inverse(fft_vars* membvars, float* input_re, float* input_im, float* output)
{
    int ti;
    int nfft;
    int hnfft;
