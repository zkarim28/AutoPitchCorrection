...
class AutoPitchCorrection //: public IPlug
{
public:
...
if(parameterID == "Mix")
        {
                autoPitchCorrector.setMixAmount(newValue);
} else if (parameterID == "Shift")
        {
    autoPitchCorrector.setShiftAmount(newValue);
} else if (parameterID == "Tune")
        {
    autoPitchCorrector.setTuneAmount(newValue);
} else if (parameterID == "Amount")
        {
    autoPitchCorrector.setAmountAmount(newValue);
} else if (parameterID == "Glide")
        {
    autoPitchCorrector.setGlideAmount(newValue);
        }
...
private:
    AutoPitchCorrection autoPitchCorrector;
};
